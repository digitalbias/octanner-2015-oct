...
Old MacDonald had a farm, E-I-E-I-O.]
    assert_equal expected, Farm.new(FarmAnimal.all(['pig'])).lyrics
  end
...
Old MacDonald had a farm, E-I-E-I-O.]
    assert_equal expected, Farm.new(FarmAnimal.all(['pig', 'owl'])).lyrics
  end
...
Old MacDonald had a farm, E-I-E-I-O.]
    assert_equal expected, Farm.new(FarmAnimal.all(['pig', '', 'duck'])).lyrics
  end
end
